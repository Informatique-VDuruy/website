...
function Reseaux() {
    return (
        <section className='ressources' id='reseaux'>
            ...
            <p>
                Afin de rejoindre le serveur discord où vous pourrez discuter avec les autres membres du club, échanger des fichier, des conseil et des idées, veuillez contacter <a href='https://github.com/TheAveron'>@TheAveron</a>.
            </p>
        </section>
    )
}
